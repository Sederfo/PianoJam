...
class JoinRoomsMenu extends React.Component {
  ...
  navigateToRoom = (roomId)=>{
    this.props.navigate(`/playingPage:${roomId}`);
  }
        ...
        >
          ...
          >
            <List style={{minHeight:"30vh"}}>
              ...
              }) : <div style={{display:"flex",minHeight:"30vh", justifyContent:"center", alignItems:"center", textAlign:"center"}}>Looks like there are no rooms yet. Create a room using the "Create Room" button!  </div>} 
